...
# save the plot 
ggsave("Noisy_WSLS_vs_Random.png", final_plt_random_vs_WSLS, width = 10, height = 10, units = "in")
...
# save the plot to drive
ggsave("Memory_Decay_vs_Random.png", final_plt_memory_decay_vs_random, width = 10, height = 10, units = "in")
```
...
ggsave("baseline_plots.png", baseline_plots, width = 15, height = 10, units = "in")
```
